...
<div class="mx-auto min-h-full w-full max-w-5xl px-4 py-8">
  <Starfield />
  ...
  <div class="flex h-full flex-col">
    <div class="flex flex-col gap-y-3">
      ...
      <span class="flex w-full justify-center font-mono font-bold">Onward</span>
    </div>
    ...
    <div class="flex w-full flex-col gap-y-9">
      <LinkButton variant="primary" width="full" href="/">
        <svg
