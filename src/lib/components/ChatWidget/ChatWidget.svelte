...
<button
  onclick={handleClick}
  class="pointer-events-auto flex cursor-pointer items-center justify-center rounded-full bg-white/30 p-5.5 shadow-sm inset-shadow-sm inset-shadow-slate-200 backdrop-blur-sm transition-all hover:-translate-y-0.5 hover:shadow-md"
