...
<div
  ...
  class="pointer-events-auto grid w-full cursor-pointer grid-cols-[auto_1fr_auto] items-center gap-x-3 rounded-full bg-white/30 px-3 py-3.5 shadow-sm inset-shadow-sm inset-shadow-slate-200 backdrop-blur-sm transition-all hover:-translate-y-0.5 hover:shadow-md"
>
