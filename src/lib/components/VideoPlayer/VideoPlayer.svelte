...
<Modal {isopen} {onclose} variant="dark">
  ...
  >
    ...
    <video
      ...
      class="aspect-video min-h-0 flex-1 rounded-lg object-contain portrait:my-auto landscape:h-full landscape:w-full landscape:rounded-none lg:landscape:h-auto lg:landscape:flex-initial"
